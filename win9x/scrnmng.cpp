...
static BOOL scrnmng_cs_initialized = 0; // Screen Manager �N���e�B�J���Z�N�V���� �������ς݃t���O
static CRITICAL_SECTION	scrnmng_cs = {0}; // Screen Manager surflock in/out �N���e�B�J���Z�N�V����
...
bool scrnmng_create_pending = false; // �O���t�B�b�N�����_�������ۗ���
bool scrnmng_restore_pending = false;
static bool scrnmng_changemode_pending = false; // ��ʃ��[�h�ύX�ۗ���
...
void scrnmng_setwindowsize(HWND hWnd, int width, int height)
{
	...
	do
	{
		RECT rectwindow;
		int marginX, marginY;
		winloc_getDWMmargin(hWnd, &marginX, &marginY); // Win10���p�̑΍�
...
void scrnmng_initialize(void) {
	...
	scrnstat.height = 400;
	scrnstat.extend = 1;
	scrnstat.multiple = 16;
	scrnmng_setwindowsize(g_hWndMain, (640 * 16) >> 3, (400 * 16) >> 3);
...
BRESULT scrnmng_create(UINT8 scrnmode) {
	...
	if(scrnmng_UIthreadID != GetCurrentThreadId()) return 1; // �ʂ̃X���b�h����̃A�N�Z�X�͕s��
...
void scrnmng_destroy(void) {
	...
	if(scrnmng_UIthreadID != GetCurrentThreadId()) return; // �ʂ̃X���b�h����̃A�N�Z�X�͕s��
...
RGB16 scrnmng_makepal16(RGB32 pal32) {
	...
	if(scrnmng_UIthreadID != GetCurrentThreadId()) return 0; // �ʂ̃X���b�h����̃A�N�Z�X�͕s��
...
const SCRNSURF *scrnmng_surflock(void) {
	if (scrnmng_changemode_pending) return NULL; // �쐬�҂��Ȃ烍�b�N���s�Ƃ���
...
BOOL scrnmng_isdispclockclick(const POINT *pt) {
	...
	if(scrnmng_UIthreadID != GetCurrentThreadId()) return FALSE; // �ʂ̃X���b�h����̃A�N�Z�X�͕s��
...
void scrnmng_blthdc(HDC hdc) {
	if (scrnmng_changemode_pending) return; // �쐬�҂��Ȃ�]�����Ȃ�
